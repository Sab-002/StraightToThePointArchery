...
<section class="hero-section text-white d-flex align-items-center" style="height: 90vh; background: linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.55)), url('{{ asset('images/archery-bg.jpg') }}') center/cover no-repeat;">
    <div class="container text-center">
        <h1 class="display-3 fw-bold fade-up">Learn Archery From Beginner to Advanced</h1>
        <p class="lead mt-3 fade-up">Professional coaching, structured classes, and expert guidance for all ages.</p>
        <a href="{{ url('/enroll') }}" class="btn btn-warning btn-lg mt-4 px-5 zoom-in">Enroll Now</a>
    </div>
</section>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card shadow border-0 h-100 text-center p-4 fade-up">
...
<section class="py-5">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card shadow-sm border-0 h-100 zoom-in">
                    <div class="card-body">
...
<section class="py-5 bg-dark text-white">
    <div class="container text-center">
        <h2 class="fw-bold mb-4 fade-left">
        <p class="lead fade-right">
